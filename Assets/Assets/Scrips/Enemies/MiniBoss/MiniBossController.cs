...
public class MiniBossController : MonoBehaviour
{
    ...
    private MiniBossHealthManager miniBossHealthManager;
    ...
    private void Awake()
    {
        ...
        miniBossHealthManager = GetComponent<MiniBossHealthManager>();
    ...
    void Update()
    {
        ...
        switch (currentState)
        {
            ...
            case IAState.Respawning:
                ...
                miniBossHealthManager.currentHealth = miniBossHealthManager.maxHealth;
                currentPatrolPoint = 0;
                waitCounter = 0;
                attackCounter = timeBetweenAttacks;
